"""Generate submission.csv using the catboost-raw agent -- same blueprint
as the other generate_submission_*.py scripts: play the actual adaptive
game against each test.txt word, terminating the instant a 6th wrong
